 ...
 * https://www.geeksforgeeks.org/problems/search-in-a-matrix-1587115621/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=bottom_sticky_on_article&authuser=0
 *
...
public class SearchInARowColumnSortedMatrix {
    public static void main(String[] args) {
        int[][] a = {{3, 30, 38}, {36, 43, 60}, {40, 51, 69}};
        int x = 43;
        System.out.println(isXElementPresentInGivenMatrix(a, x));
    }

    private static int isXElementPresentInGivenMatrix(int[][] a, int x) {
        int col = 0;
        int row = a.length - 1;
